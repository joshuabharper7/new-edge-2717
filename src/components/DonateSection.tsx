...
import { Heart, Repeat, ShieldCheck, ArrowRight, Sparkles, CheckCircle2 } from 'lucide-react';
    ...
    <section id="give" className="py-24 bg-[#1A2229] border-t border-slate-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="inline-flex bg-[#11161B] p-1.5 rounded-2xl border border-slate-800 mt-8">
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {tiers.map((tier) => (
            ...
            >
              ...
              >
                <span>Partner with ${tier.amount}</span>
